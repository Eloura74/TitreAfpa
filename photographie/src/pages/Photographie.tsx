...
export default function Photographie() {
  ...
  useEffect(() => {
    const fetchImages = async () => {
      try {
        // Récupérer une image aléatoire de la galerie photo publique
    ...
    <div className="home-page min-h-screen flex flex-col bg-[#0a0a10]">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-12">
          ...
          <span className="block mt-6 text-sm text-[#ffe992]/80 uppercase tracking-widest font-medium drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
